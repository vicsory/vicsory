...
-- AddForeignKey
ALTER TABLE "Repost" ADD CONSTRAINT "Retweet_retweetedById_fkey" FOREIGN KEY ("retweetedById") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Repost" ADD CONSTRAINT "Retweet_tweetOriginId_fkey" FOREIGN KEY ("tweetOriginId") REFERENCES "Tweet"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
