...
export const getUserPost = async (postId: string, postAuthor: string) => {
    const response = await fetch(`${HOST_URL}/api/posts/${postAuthor}/${postId}`, {
        next: {
            revalidate: 0,
        },
    });
...
export const updatePostLikes = async (postId: string, postAuthor: string, tokenOwnerId: string, isLiked: boolean) => {
    const route = isLiked ? "unlike" : "like";
    const response = await fetch(`${HOST_URL}/api/posts/${postAuthor}/${postId}/${route}`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
        },
...
export const updateReposts = async (postId: string, postAuthor: string, tokenOwnerId: string, isReposted: boolean) => {
...
export const deletePost = async (postId: string, postAuthor: string, tokenOwnerId: string) => {
    const response = await fetch(`${HOST_URL}/api/posts/${postAuthor}/${postId}/delete`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
        },
...
export const createReply = async (reply: string, postAuthor: string, postId: string) => {
    const response = await fetch(`${HOST_URL}/api/posts/${postAuthor}/${postId}/reply`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
        },
...
export const addStory = async (img: string) => {
    const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/stories/create`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
        },
