...
import {BadgeGold} from "../../../public/svg/verify-badge";
...
export default function VipUsers({ user }: { user: UserPropsWithRemove }) {
            ...
            <div className="flex-1 flex flex-col justify-between min-w-0 cursor-pointer select-none">
                ...
                <div className="flex justify-between items-start gap-2">
                    <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-1 font-medium text-[15px] truncate">
                            {truncatedName}
                            {user.isElite && <BadgeGold />}
                        </div>
