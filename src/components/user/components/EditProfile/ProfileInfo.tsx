  ...
  return (
    <div className="relative px-4 pt-16 pb-4">
      ...
      <div className="flex flex-col gap-1">
        ...
        <div className="text-muted flex items-center flex-wrap gap-2">
            ...
            <TooltipProvider delayDuration={200}>
              <Tooltip>
                <TooltipTrigger>
                  <Badge
                    variant="secondary"
                    className="rounded-full border border-solid border-[var(--border-color)] hover:border-[var(--border-color)] bg-[var(--hover)] text-muted hover:bg-transparent hover:text-muted text-[13px] font-normal transition-colors"
                  >
                    {categoryFormatted}
                  </Badge>
                </TooltipTrigger>
