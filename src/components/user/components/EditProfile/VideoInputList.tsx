        ...
        <div key={index} className="space-y-2">
          <div className="flex items-center gap-2">
            <Input
              ...
              className={`flex-1 bg-[var(--background-primary)] border-[var(--border-color)] text-[var(--active-mode)] hover:bg-[var(--hover)] focus:outline-none focus:border-[var(--blue)] focus:border-2 ${
          ...
          <Input
            ...
            className="bg-[var(--background-primary)] border-[var(--border-color)] text-[var(--active-mode)] hover:bg-[var(--hover)] focus:outline-none focus:border-[var(--blue)] focus:border-2"
          />
