  ...
  return (
    <div className="w-full mx-auto px-0">
      ...
      <div className="w-full relative mb-2">
          ...
          <>
            <div className="absolute top-4 right-4 flex items-center gap-3 z-20 pl-4">
              ...
              <button
                ...
                className="w-10 h-10 rounded-full bg-[var(--blue)] hover:bg-[var(--hover-blue)] flex items-center justify-center shadow-lg transition-all duration-200 hover:scale-105"
            ...
            {isPlaying && (
              <div className="absolute bottom-4 right-4 flex items-center gap-2 z-20 bg-black/70 p-2 rounded-full">
                <button
                  ...
                  className="w-8 h-8 rounded-full bg-black hover:bg-[var(--hover-blue)] flex items-center justify-center transition-all duration-200 hover:scale-105"
        ...
        <div className="cursor-pointer absolute -bottom-[50px] left-4 border border-solid border-[var(--border-color)] rounded-full p-1 bg-[var(--background-primary)] z-10">
              ...
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger>
                    <Badge
                      variant="secondary"
                      className="rounded-full text-sm border border-solid border-[var(--border-color)] hover:border-[var(--border-color)] ml-2 bg-[var(--hover)] text-muted hover:bg-transparent hover:text-muted  font-normal"
                    >
            ...
            <div className="flex flex-wrap gap-2 w-full mt-2">
              {socialLinks.map((link) => (
                <Link
                  ...
                  className="flex items-center justify-center w-10 h-10 rounded-full border border-solid border-[var(--border-color)] text-[var(--active-mode)] hover:bg-[var(--hover)] hover:text-[var(--blue)] transition-colors duration-200"
                  title={link.name}
                >
                  {link.icon}
                </Link>
      ...
      <Tabs defaultValue={getActiveTab()} className="w-full mt-2">
        <TabsList className="w-full flex justify-around border-b border-solid border-[var(--border-color)] bg-transparent">
          <TabsTrigger
            value="posts"
            className="text-[15px] flex items-center justify-center text-muted w-full font-bold py-3 relative hover:bg-[var(--hover)] transition-colors duration-100 group data-[state=active]:text-[var(--active-mode)]"
            asChild
          >
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogContent className="max-w-md p-4 bg-[var(--background-primary)] rounded-lg shadow-lg">
            ...
            <Input
              ...
              className="mb-4 w-full rounded-md border border-solid border-[var(--border-color)] px-3 py-2 text-[15px] text-black placeholder:text-muted focus:outline-none focus:ring-2 focus:ring-[var(--blue)]"
            />
