...
import { checkBlueFromServer } from "@/utilities/fetch/misc/checkBlue";
...
export default function EditProfile({ profile, refreshToken }: { profile: ExtendedUserProps; refreshToken: () => void }) {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto">
      ...
      {/* Form Section */}
      <div className="mt-20 px-6 pb-6 bg-[var(--background-primary)] rounded-b-lg border border-solid border-[var(--border-color)]">
        <div className="flex justify-between items-center mb-6 pt-6">
          <h1 className="text-2xl font-bold text-[var(--active-mode)]">Edit Profile</h1>
          <Button
            variant="ghost"
            className="text-base text-[var(--blue)] hover:text-[var(--hover-blue)]"
        ...
        <form onSubmit={formik.handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              <label htmlFor="tiktok" className="flex items-center space-x-2">
                <FaTiktok size={20} color="var(--active-mode)" />
              ...
              <Input
                ...
                onChange={formik.handleChange}
                className={`w-full bg-[var(--background-primary)] border-[var(--border-color)] text-[var(--active-mode)] hover:bg-[var(--hover)] focus:outline-none focus:border-[var(--blue)] focus:border-2 ${
                  formik.touched.tiktok && formik.errors.tiktok ? "border-[var(--red)]" : ""
                }`}
              />
            ...
            <div className="space-y-1">
              ...
              <Input
                ...
                onChange={formik.handleChange}
                className={`w-full bg-[var(--background-primary)] border-[var(--border-color)] text-[var(--active-mode)] hover:bg-[var(--hover)] focus:outline-none focus:border-[var(--blue)] focus:border-2 ${
                  formik.touched.youtube && formik.errors.youtube ? "border-[var(--red)]" : ""
                }`}
              />
            ...
            <div className="space-y-1">
              <label htmlFor="facebook" className="flex items-center space-x-2">
                <FaFacebook size={20} color="var(--active-mode)" />
              ...
              <Input
                ...
                onChange={formik.handleChange}
                className={`w-full bg-[var(--background-primary)] border-[var(--border-color)] text-[var(--active-mode)] hover:bg-[var(--hover)] focus:outline-none focus:border-[var(--blue)] focus:border-2 ${
                  formik.touched.facebook && formik.errors.facebook ? "border-[var(--red)]" : ""
                }`}
              />
            ...
            <div className="space-y-1">
              <label htmlFor="x" className="flex items-center space-x-2">
                <XIcon size={20} color="var(--active-mode)" />
              ...
              <Input
                ...
                onChange={formik.handleChange}
                className={`w-full bg-[var(--background-primary)] border-[var(--border-color)] text-[var(--active-mode)] hover:bg-[var(--hover)] focus:outline-none focus:border-[var(--blue)] focus:border-2 ${
                  formik.touched.x && formik.errors.x ? "border-[var(--red)]" : ""
                }`}
              />
            ...
            <div className="space-y-1">
              <label htmlFor="instagram" className="flex items-center space-x-2">
                <FaInstagram size={20} color="var(--active-mode)" />
              ...
              <Input
                ...
                onChange={formik.handleChange}
                className={`w-full bg-[var(--background-primary)] border-[var(--border-color)] text-[var(--active-mode)] hover:bg-[var(--hover)] focus:outline-none focus:border-[var(--blue)] focus:border-2 ${
                  formik.touched.instagram && formik.errors.instagram ? "border-[var(--red)]" : ""
                }`}
              />
            ...
            <div className="space-y-1">
              <label htmlFor="twitch" className="flex items-center space-x-2">
                <FaTwitch size={20} color="var(--active-mode)" />
              ...
              <Input
                ...
                onChange={formik.handleChange}
                className={`w-full bg-[var(--background-primary)] border-[var(--border-color)] text-[var(--active-mode)] hover:bg-[var(--hover)] focus:outline-none focus:border-[var(--blue)] focus:border-2 ${
                  formik.touched.twitch && formik.errors.twitch ? "border-[var(--red)]" : ""
                }`}
              />
            ...
            {/* Bluesky */}
            <div className="space-y-1">
              <label htmlFor="bluesky" className="flex items-center space-x-2">
                <SiBluesky size={20} color="var(--active-mode)" />
                <span className="text-sm text-gray-500" title={socialMediaBaseUrls.bluesky}>
                  {socialMediaBaseUrls.bluesky}
                </span>
              </label>
              <Input
                name="bluesky"
                placeholder="Bluesky Username"
                value={formik.values.bluesky}
                onChange={formik.handleChange}
                className={`w-full bg-[var(--background-primary)] border-[var(--border-color)] text-[var(--active-mode)] hover:bg-[var(--hover)] focus:outline-none focus:border-[var(--blue)] focus:border-2 ${
                  formik.touched.bluesky && formik.errors.bluesky ? "border-[var(--red)]" : ""
                }`}
              />
              {formik.touched.bluesky && formik.errors.bluesky && (
                <p className="text-[var(--red)] text-sm">{formik.errors.bluesky}</p>
              )}
            </div>
          </div>
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-[var(--active-mode)]">Profile Videos</h3>
            <VideoInputList
