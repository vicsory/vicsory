...
const Topbar = () => {
  ...
  return (
    <>
      ...
      >
        <div
          className={`absolute inset-0 border-b border-solid border-[var(--border-color)] bg-[var(--background-primary)]/80 backdrop-blur-xl h-full gap-8 flex items-center justify-between px-4 pointer-events-auto `}
        >
          <Link href="/explore" className="w-fit pl-2 gap-2 top-0 items-center flex" style={{ cursor: "pointer" }}>
            ...
            <span className="text-2xl font-bold text-[var(--active-mode)]">vicsory</span>
          </Link>
          {/* Search */}
          <Search />
          ...
          <div className="flex items-center gap-3">
            {!token ? (
              <Button
                ...
                className="border border-solid bg-[var(--hover)] border-[var(--border-color)] rounded-full px-3 sm:px-5 py-2.5 font-medium flex items-center gap-2 hover:bg-[var(--hover)]"
              >
