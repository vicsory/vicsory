...
const NotificationFill: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => {
  return (
    <svg
...
const NotificationOutline: React.FC<{ className?: string; strokeWidth?: number }> = ({
  className = "w-6 h-6",
...
export { NotificationFill, NotificationOutline };
