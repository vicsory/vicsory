...
const ProfileFill: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => {
  return (
    <svg
...
const ProfileOutline: React.FC<{ className?: string; strokeWidth?: number }> = ({
  className = "w-6 h-6",
}) => {
  return (
    <svg
...
export { ProfileFill, ProfileOutline };
