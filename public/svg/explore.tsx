...
const ExploreFill: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => {
  return (
    <svg
...
const ExploreOutline: React.FC<{ className?: string; strokeWidth?: number }> = ({
  className = "w-6 h-6",
}) => {
  return (
    <svg
...
export { ExploreFill, ExploreOutline };
